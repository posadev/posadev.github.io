                        ...
                        <div className="space-y-8">
                            <div>
                                ...
                                <div className="space-y-4">
                                    <div
                                        className="flex items-start space-x-4 p-4 bg-white rounded-xl shadow-sm hover-scale">
                                        <div
                                        ...
                                        <div>
                                            <h4 className="font-semibold text-posadev-black mb-2">Visibilidad de
                                                marca</h4>
                                            <p className="text-gray-600">Expón tu marca ante cientos de desarrolladores
                                                y profesionales de la tecnología</p>
                                        </div>
                                    </div>
                                    ...
                                    <div
                                        ...
                                        <div>
                                            ...
                                            <p className="text-gray-600">Expande tus redes de comunidades de
                                                desarrolladores</p>
                                        </div>
                                    </div>
                                    ...
                                    <div
                                        ...
                                        <div>
                                            ...
                                            <p className="text-gray-600">Contribuye al crecimiento de las comunidades de
                                                la region</p>
                                        </div>
                                    </div>
                                </div>
