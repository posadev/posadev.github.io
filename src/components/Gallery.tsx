...
const Gallery = () => {
    ...
    return (
        <section
            ...
            {/* Section header */}
            <h2 id="gallery-title" className="text-4xl md:text-5xl font-bold text-alternative-700 mb-4">
                Galería de Momentos
            </h2>
            <p className="text-xl text-gray-600 max-w-2xl flex gap-2 justify-center items-center">
